    ...
    <>
      <section className="px-6 py-20 max-w-7xl mx-auto">
        <div className="text-center max-w-4xl mx-auto mb-16">
          <FadeIn>
            <h1 className="text-5xl md:text-7xl font-fraunces font-bold mb-6 text-brand-slate">Three ways to make a difference.</h1>
          </FadeIn>
        </div>

        <div className="grid lg:grid-cols-3 gap-8 mb-24">
          <FadeIn delay={0.1} className="bg-brand-red text-white p-10 rounded-3xl shadow-xl flex flex-col h-full">
            <h2 className="text-3xl font-fraunces font-bold mb-6">Donate</h2>
            <p className="text-lg opacity-90 mb-10 flex-1 font-medium leading-relaxed">
          ...
          <FadeIn delay={0.2} className="bg-brand-mustard text-brand-slate p-10 rounded-3xl shadow-xl flex flex-col h-full">
            <h2 className="text-3xl font-fraunces font-bold mb-6">Volunteer</h2>
            <p className="text-lg opacity-90 mb-10 flex-1 font-medium leading-relaxed">
          ...
          <FadeIn delay={0.3} className="bg-brand-forest text-brand-cream p-10 rounded-3xl shadow-xl flex flex-col h-full">
            <h2 className="text-3xl font-fraunces font-bold mb-6">Spread the Word</h2>
            <p className="text-lg opacity-90 mb-10 flex-1 font-medium leading-relaxed">
        ...
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row gap-16 items-start">
          <FadeIn className="md:w-1/2">
            <h2 className="text-4xl font-fraunces font-bold mb-6 text-brand-slate">Why Grassroots?</h2>
            <div className="prose prose-lg prose-p:leading-relaxed font-medium text-brand-slate/80">
              <p>
                This campaign is rooted in people, not big money. Our goal is to build a grassroots movement powered by residents, volunteers, and community members who believe in stronger neighbourhoods, safer communities, and real change at City Hall.
              </p>
              <p>
          ...
          <FadeIn delay={0.2} className="md:w-1/2 bg-white p-10 rounded-3xl shadow-sm border border-brand-slate/10">
            <h2 className="text-2xl font-fraunces font-bold mb-6 text-brand-red">Where your contribution goes</h2>
            <ul className="space-y-4 text-lg font-medium text-brand-slate/80">
              <li className="flex items-start gap-4">
                <span className="text-brand-mustard font-bold text-2xl leading-none">&bull;</span>
